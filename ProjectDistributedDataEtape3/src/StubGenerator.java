...
public class StubGenerator {
	...
	public static void createStub(Class c) {
		try {
            String simpleInterfaceName = c.getSimpleName();
			String simpleClassName = simpleInterfaceName.substring(0, simpleInterfaceName.length() - 4);
            ...
            textFile = textFile.replaceAll("abstract ","");
