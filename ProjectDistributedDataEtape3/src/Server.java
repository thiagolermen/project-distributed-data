...
public class Server extends UnicastRemoteObject implements Server_itf {
	...
	protected Server() throws RemoteException {
		...
		// Sets the type of deserialization as Server to Client
		TypeOfDeserialization.setTypeOfDeserialization(false);
	}

	/**
	 * Searches for name in the register of names and returns its id
	 * @return id of the object with name
	 */
