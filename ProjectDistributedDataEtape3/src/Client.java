...
/////////////////////////////////////////////////////////////
	...
	*/
	...
	/**
	 * Gets the stub of an object of given id
	 * @param id of the object
	 * @return the stub that has been cached or null if the object is not found
	 */
	public static SharedObject getStub(int id) {
		
		return possessedObjects.get(id);
