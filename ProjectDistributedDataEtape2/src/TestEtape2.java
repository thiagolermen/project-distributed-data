...
public class TestEtape2 extends JFrame {
	...
	public TestEtape2(SharedObject s) {
...
class StartListener implements ActionListener {
	...
	public StartListener(TestEtape2 i, JButton button) {
		irc = i;
		start_button = button;
